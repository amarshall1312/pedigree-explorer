#!/bin/bash
# s02_illumina_plink_3_Split
#
# Cameron Brown 20Mar2026

# Crescent2 script
# Note: this script should be run on a compute node
# qsub s02_illumina_plink_3_Split

# PBS directives
#---------------

#PBS -N s02_illumina_plink_3_Split
...
input_vcf="${clean_vcf_folder}/illumina_clean_3_Split.vcf.gz"

# Outputs
output_prefix="${plink_files_folder}/illumina_clean_3_Split"
