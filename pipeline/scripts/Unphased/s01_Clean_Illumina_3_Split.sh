#!/bin/bash
# s01_Illumina_Clean_3_split
#
# Cameron Brown 2026

# Crescent2 script
# Note: this script should be run on a compute node
# qsub s01_Illumina_Clean_3_split

# PBS directives
#---------------

#PBS -N s01_Illumina_Clean_3_split
...
input_vcf="${base_folder}/data/raw/illumina/3_split/Illumina_Preprocessing_3_Split.vcf.gz"

# Outputs
output_vcf="${clean_vcf_folder}/illumina_clean_3_Split.vcf.gz"
